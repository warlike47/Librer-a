...
<head>
    <title> Dibujar ruta entre 2 sitios</title>
        ...
        <div class="col-sm-4">
            ...
            <form id="distance_form">
                ...
                <div class="form-group"><label>Origen: </label>
                    <input class="form-control" id="from_places" placeholder="Introduzca lugar de origen"/>
                    <input id="origin" name="origin" required="" type="hidden"/>
                    <a class="form-control" onclick="getCurrentPosition()">Poner posición actual</a>
                </div>

                <div class="form-group"><label>Destino: </label>
                    <input class="form-control" id="to_places" placeholder="Introduzca lugar a ir"/>
