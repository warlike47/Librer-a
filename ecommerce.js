$(document).ready(function () {
    ...
    $(document).on("click",".mas,.menos",function(e){
        ...
        $.ajax({
            type: "post",
            url: "cambiaCantidadProductos.php",
    ...
    function llenaCarrito(response){
        ...
        response.forEach(element => {
            $("#listaCarrito").append(
                `
                <a href="tienda.php?modulo=detalleproducto&id=${element['id']}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
        ...
        $("#listaCarrito").append(
            `
            <a href="tienda.php?modulo=carrito" class="dropdown-item dropdown-footer text-primary">
                Ver carrito 
