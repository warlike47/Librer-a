        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card border-primary">
                ...
                <div class="card-body">
                    ...
                    <a href="tienda.php?modulo=detalleproducto&id=<?php echo $row['id'] ?>" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
    <?php
...
?>
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            ?>
                <li class="page-item">
                    <a class="page-link" href="tienda.php?modulo=productos&pagina=<?php echo ($paginaSel - 1); ?>" aria-label="Previous">
            ...
            ?>
                <li class="page-item <?php echo ($paginaSel == $i) ? " active " : " "; ?>">
                    <a class="page-link" href="tienda.php?modulo=productos&pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
            <?php
            }
            ?>
            ...
            ?>
                <li class="page-item">
                    <a class="page-link" href="tienda.php?modulo=productos&pagina=<?php echo ($paginaSel + 1); ?>" aria-label="Next">
